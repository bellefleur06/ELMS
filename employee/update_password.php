    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                ...
                <?php if (isset($_SESSION['update-employee-password-success'])) : ?>
                    <h5 id="alert" class="alert alert-success"><?php echo $_SESSION['update-employee-password-success']; ?></h5>
                <?php
                    unset($_SESSION['update-employee-password-success']);
                endif; ?>
                <?php if (isset($_SESSION['update-employee-password-failed'])) : ?>
                    <h5 id="alert" class="alert alert-danger"><?php echo $_SESSION['update-employee-password-failed']; ?></h5>
                <?php
                    unset($_SESSION['update-employee-password-failed']);
                endif; ?>
                                        ...
                                        <form class="form" action="../includes/actions.php" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 d-flex justify-content-end">
                                                    <button type="submit" name="update_employee_password" class="btn btn-primary me-1 mb-1">Save</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
