    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                ...
                <?php if (isset($_SESSION['leave_application-not-found'])) : ?>
                    <h5 id="alert" class="alert alert-success"><?php echo $_SESSION['leave_application-not-found']; ?></h5>
                <?php
                    unset($_SESSION['leave_application-not-found']);
                endif;
                ?>
                        ...
                        <div class="card-body">
                            <table class='table' id="table1">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT * FROM leave_types, employees, leave_applications WHERE leave_applications.leave_type_id = leave_types.id AND leave_applications.employee_id = employees.id";
