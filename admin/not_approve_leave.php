                        ...
                        <div class="card-body">
                            <table class='table' id="table1">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT * FROM leave_types, employees, leave_applications WHERE leave_applications.leave_type_id = leave_types.id AND leave_applications.employee_id = employees.id AND leave_applications.leave_status = '2'";
