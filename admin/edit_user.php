                                        ...
                                        <form class="form" action="../includes/actions.php" method="post">
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="position-relative">
                                                            <fieldset class="form-group">
                                                                <select class="form-select" name="user_category" id="basicSelect">
                                                                    <option value="Admin" <?php echo ($results->user_category == "Admin") ? 'selected' : ''; ?>>Admin</option>
                                                                    <option value="Staff" <?php echo ($results->user_category == "Staff") ? 'selected' : ''; ?>>Staff</option>
                                                                </select>
                                                            </fieldset>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <button type="submit" name="edit_user" class="btn btn-primary me-1 mb-1 float-end">Save</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
